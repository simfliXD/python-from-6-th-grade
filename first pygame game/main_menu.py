...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text(
                "Thx ( CDcodes ) for helping with this menu",
                15,
                self.game.DISPLAY_W / 2,
                self.game.DISPLAY_H / 2 + 10,
            )
            self.game.draw_text(
                "When I made a menu all by my own it had many bugs",
                15,
                self.game.DISPLAY_W / 2,
                self.game.DISPLAY_H / 2 + 28,
            )
            self.game.draw_text(
                "That where just to hard for me to fix by my own",
                15,
                self.game.DISPLAY_W / 2,
                self.game.DISPLAY_H / 2 + 43,
            )
